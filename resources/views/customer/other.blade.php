                    ...
                    <div class="card">
                        <form action="{{route('fund.save')}}" method="POST" enctype="multipart/form-data">@csrf
                            <div class="card-header">
                                <h5>E-Bank Other Account-Fund Transfer</h5>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6   ">
                                        ...
                                        <input type="text" class="form-control" name="balance" value="{{ old('balance') ? : auth()->user()->account->balance }}">
                                    </div>
                                    <div class="col-sm-6 ">
                                ...
                                <div class="row">
                                    <div class="col-sm-6   ">
                                        ...
                                        <select name="branch" id="branch" class="form-control">
                                            @foreach($e_branches as $e_branch)
                                                <option value="bkash">{{$e_branch->branch}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-6 ">
                                        ...
                                        <select name="city" id="city" class="form-control">
                                            @foreach($e_branches as $e_branch)
                                                <option value="city">{{$e_branch->district}}</option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('city'))
